...
class TextAiClient(Protocol):
    def rewrite_note(self, *, model_config: ModelConfig, api_key: str, title: str, body: str, instruction: str) -> str: ...
    def generate_note(self, *, model_config: ModelConfig, api_key: str, topic: str, reference: str, instruction: str) -> dict[str, str]: ...
    def generate_titles(self, *, model_config: ModelConfig, api_key: str, title: str, body: str, count: int) -> list[str]: ...
    def generate_tags(self, *, model_config: ModelConfig, api_key: str, title: str, body: str, count: int) -> list[str]: ...
    def polish_text(self, *, model_config: ModelConfig, api_key: str, text: str, instruction: str) -> str: ...


class ImageAiClient(Protocol):
    def generate_cover(self, *, model_config: ModelConfig, api_key: str, prompt: str, size: str, style: str) -> dict[str, Any]: ...
    def generate_image(self, *, model_config: ModelConfig, api_key: str, prompt: str, reference_images: list[str] | None = None) -> dict[str, Any]: ...
    def describe_image(self, *, model_config: ModelConfig, api_key: str, image_url: str, instruction: str) -> str: ...
...
class OpenAICompatibleTextClient:
    ...
    def rewrite_note(self, *, model_config: ModelConfig, api_key: str, title: str, body: str, instruction: str) -> str:
        return self._complete(
            ...
            user_prompt=f"改写要求：{instruction or '提升表达、增强小红书语感'}\n\n标题：{title}\n\n正文：\n{body}",
        )
