...
class TestCollectorsAPI:
    ...
    def test_validate_config_rejects_unknown_type(self, client):
        config = {
    ...
    def test_validate_config_rejects_xhs_type(self, client):
        config = {
            "collector_type": "xhs",
        }
        response = client.post("/api/collectors/validate-config", json=config)
    ...
    def test_validate_config_valid_media_crawler(self, client):
        config = {
    ...
    def test_validate_config_valid_media_crawler_with_cookies(self, client):
        config = {
            "collector_type": "media_crawler",
            "login_type": "cookie",
    ...
    def test_collectors_health(self, client):
