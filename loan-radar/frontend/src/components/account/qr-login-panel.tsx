...
import { createXhsCreatorQrLoginSession, createXhsPcQrLoginSession, pollXhsLoginSession } from "../../api/xhs-api";
import type { PlatformAccount, XhsQrLoginSession } from "../../api/xhs-types";
  ...
  return (
    <Space direction="vertical" size="middle" style={{ width: "100%" }}>
      ...
      <div style={{ textAlign: "center" }}>
        <Text strong style={{ display: "block", marginBottom: 4, color: "rgba(0,0,0,0.88)" }}>
          {statusText}
        </Text>
        {session?.qr_url ? (
