...
import type { KeywordGroup, KeywordGroupDetail } from "../../api/xhs-types";
...
export function XhsKeywordsPage() {
  ...
  return (
    <div>
      ...
      <Card
        style={{ background: "#FFFFFF", borderColor: "#E8E8E8", marginBottom: 24 }}
      >
      ...
      {isLoading ? (
        ...
        <Card style={{ background: "#FFFFFF", borderColor: "#E8E8E8" }}>
