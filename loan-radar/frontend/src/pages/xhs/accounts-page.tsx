...
import { checkAccount, deleteAccount, fetchAccounts } from "../../api/xhs-api";
    ...
    <div style={{ padding: "0 0 32px" }}>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <Title level={3} style={{ margin: 0, color: "rgba(0,0,0,0.88)" }}>
              账号矩阵
            </Title>
            <Text style={{ color: "rgba(0,0,0,0.45)", marginTop: 4, display: "block" }}>
      ...
      <Card
        title={
          <span style={{ color: "rgba(0,0,0,0.88)", fontWeight: 600 }}>已绑定账号</span>
        }
        extra={
      ...
      >
        ...
        {isLoading ? (
          ...
          <Empty
            image={<SafetyCertificateOutlined style={{ fontSize: 48, color: "rgba(0,0,0,0.25)" }} />}
            ...
            description={
              <Space direction="vertical" size={4}>
                ...
                <Text style={{ color: "rgba(0,0,0,0.35)", fontSize: 13 }}>
              ...
              return (
                <Col xs={24} sm={24} md={12} lg={8} key={account.id}>
                  <Card
                    ...
                    style={{
                      background: "#FFFFFF",
                      borderColor: isCreator ? "#D6E4FF" : "#E8E8E8",
                  ...
                  >
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                      <Avatar
                        ...
                        style={{ background: "#F5F7FA", flexShrink: 0 }}
                      >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <Text
                          strong
                          ellipsis
                          style={{ display: "block", color: "rgba(0,0,0,0.88)", fontSize: 15 }}
                        >
                        ...
                        <Text
                          type="secondary"
                          ellipsis
                          style={{ display: "block", fontSize: 12, color: "rgba(0,0,0,0.35)" }}
                        >
                    ...
                    {isCreator ? (
                      <Row gutter={16} style={{ marginBottom: 12 }}>
                        <Col xs={12} span={12}>
                          <Statistic
                            title={<span style={{ color: "rgba(0,0,0,0.45)", fontSize: 12 }}>类型</span>}
                            value="Creator"
                            valueStyle={{ color: "rgba(0,0,0,0.88)", fontSize: 14 }}
                          />
                        </Col>
                        {profileValue(account, "red_id") ? (
                          <Col xs={12} span={12}>
                            <Statistic
                              title={<span style={{ color: "rgba(0,0,0,0.45)", fontSize: 12 }}>小红书号</span>}
                      ...
                      <Row gutter={12} style={{ marginBottom: 12 }}>
                        ...
                        <Col xs={12} sm={6}>
                          <Statistic
                            title={<span style={{ color: "rgba(0,0,0,0.45)", fontSize: 12 }}>粉丝</span>}
                        ...
                        <Col xs={12} sm={6}>
                          <Statistic
                            title={<span style={{ color: "rgba(0,0,0,0.45)", fontSize: 12 }}>关注</span>}
                        ...
                        <Col xs={12} sm={6}>
                          <Statistic
                            title={<span style={{ color: "rgba(0,0,0,0.45)", fontSize: 12 }}>获赞</span>}
                    ...
                    {account.status_message ? (
                      <Text
                        type="secondary"
                        style={{ display: "block", fontSize: 12, marginBottom: 12, color: "rgba(0,0,0,0.35)" }}
                      >
                        {account.status_message}
                      </Text>
                    ) : null}
                    ...
                    >
                      <Text style={{ fontSize: 11, color: "rgba(0,0,0,0.25)" }}>
