...
import type { PlatformAccount, PublishAsset, PublishJob } from "../../api/xhs-types";
                  ...
                  <Row gutter={16}>
                    ...
                    <Col xs={24} md={14}>
                      ...
                      >
                        ...
                        <Paragraph style={{ whiteSpace: "pre-wrap", color: "rgba(0,0,0,0.65)", fontSize: 13, marginBottom: 16 }}>
