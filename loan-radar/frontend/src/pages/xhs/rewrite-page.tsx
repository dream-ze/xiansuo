...
import type { DraftAsset } from "../../api/xhs-api";
import type { Draft, GeneratedImageAsset, SavedNote, UserImageFile } from "../../api/xhs-types";
    ...
    <div ref={setNodeRef} style={style} {...attributes} {...listeners}>
      ...
      <Button
        ...
        style={{
          ...
          background: "rgba(0,0,0,.06)", borderRadius: "50%", color: "#1668dc",
        }}
      />
      ...
      <Button
        ...
        style={{
          ...
          width: 18, height: 18, minWidth: 18, padding: 0,
          background: "rgba(0,0,0,.06)", borderRadius: "50%", color: "#fff",
        }}
      />
    </div>
  );
      ...
      <Row gutter={16}>
                  ...
                  return (
                    <List.Item
                      ...
                      style={{
                        cursor: "pointer",
                        padding: "10px 16px",
                        background: isActive ? "#2F54EB10" : "transparent",
                    ...
                    <SortableContext items={imageAssets.map((a) => a.id)} strategy={horizontalListSortingStrategy}>
                      <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
                        ...
                        <div
                          ...
                          style={{
                            width: 60, height: 60, borderRadius: 4, border: "1px dashed #D9D9D9",
        ...
        <Col xs={24} lg={6}>
          ...
          <Card title="AI 助手" size="small">
            ...
            {rewritePreview !== null && (
              <Card size="small" title="改写结果" style={{ marginBottom: 16, background: "#F0F5FF", borderColor: "#2F54EB40" }}>
                <Paragraph style={{ whiteSpace: "pre-wrap", color: "rgba(0,0,0,0.65)", fontSize: 13, maxHeight: 240, overflow: "auto" }}>{rewritePreview}</Paragraph>
            ...
            return (
              <div>
                <Row gutter={16} style={{ marginBottom: 16 }}>
                  <Col xs={24} sm={12}>
                    <div style={{ padding: 8, background: "rgba(0,0,0,0.04)", borderRadius: 8, textAlign: "center" }}>
                  ...
                  <Col xs={24} sm={12}>
                    <div style={{ padding: 8, background: "rgba(0,0,0,0.04)", borderRadius: 8, textAlign: "center" }}>
                      ...
                      {optimizeResult ? (
                        ...
                        <div style={{ width: 180, height: 180, margin: "0 auto", border: "1px dashed #D9D9D9", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center" }}>
                        ...
                        {optimizeRefImages.map((url, idx) => (
                          <div key={idx} style={{ position: "relative", width: 40, height: 40, borderRadius: 4, overflow: "hidden", border: "1px solid #333" }}>
                            ...
                            <Button type="text" danger size="small" icon={<DeleteOutlined />}
                              ...
                              style={{ position: "absolute", top: -4, right: -4, fontSize: 8, width: 14, height: 14, minWidth: 14, padding: 0, background: "rgba(0,0,0,.06)", borderRadius: "50%" }}
                            />
                          </div>
                        ))}
                        <div
                          ...
                          style={{ width: 40, height: 40, borderRadius: 4, border: "1px dashed #D9D9D9", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", background: "rgba(0,0,0,0.04)" }}
                        >
