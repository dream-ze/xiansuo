...
async def start_crawler(request: CrawlerStartRequest):
    """Start crawler task"""
    print(f"[API] Start request: platform={request.platform}, type={request.crawler_type}, keywords='{request.keywords}', specified_ids='{request.specified_ids}', creator_ids='{request.creator_ids}'")
